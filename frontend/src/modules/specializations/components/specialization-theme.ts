...
const fallbackTheme: SpecializationTheme = {
  ...
  selectedChipClassName: "border-slate-700 bg-slate-700 text-white",
...
const specializationThemes: Array<{ matches: string[]; theme: SpecializationTheme }> = [
  {
    ...
    theme: {
      ...
      selectedChipClassName: "border-teal-500 bg-teal-500 text-white",
  ...
  },
  {
    ...
    theme: {
      ...
      selectedChipClassName: "border-violet-500 bg-violet-500 text-white",
  ...
  },
  {
    ...
    theme: {
      ...
      selectedChipClassName: "border-amber-500 bg-amber-500 text-white",
  ...
  },
  {
    ...
    theme: {
      ...
      selectedChipClassName: "border-sky-500 bg-sky-500 text-white",
  ...
  },
  {
    ...
    theme: {
      ...
      selectedChipClassName: "border-emerald-500 bg-emerald-500 text-white",
  ...
  },
  {
    ...
    theme: {
      ...
      selectedChipClassName: "border-rose-500 bg-rose-500 text-white",
